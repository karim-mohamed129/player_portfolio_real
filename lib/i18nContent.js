...
export const defaultEnglishContent = {
  ...
  career: {
    ...
    items: [
      { year: "2018", title: "Youth development stage", description: "Early technical development in a local academy with focus on individual skills and speed.", image: "/assets/career/2018.jpg" },
      { year: "2021", title: "First competitive season", description: "Regular team appearances with meaningful goal contributions across several competitions.", image: "/assets/career/2021.jpg" },
      { year: "2024", title: "Promotion to first team", description: "More playing minutes and appearances in official and friendly matches against stronger levels.", image: "/assets/career/2024.jpg" },
      { year: "2026", title: "Ready for evaluation", description: "A complete professional file for clubs including CV, statistics, photos, and video material.", image: "/assets/career/2026.jpg" }
    ]
  },
  achievements: {
    label: "Achievements",
    ...
    items: [
      { icon: "trophy", title: "Player of the Month", description: "Recognized for clear attacking impact and a high contribution rate.", image: "/assets/achievements/trophy.jpg" },
      { icon: "medal", title: "Team top scorer", description: "The highest number of direct goal contributions during the season.", image: "/assets/achievements/scorer.jpg" },
      { icon: "star", title: "Strong commitment record", description: "Consistent training attendance and high physical readiness.", image: "/assets/achievements/commitment.jpg" }
    ]
  },
  media: {
    label: "Media",
    ...
    items: [
      { image: "/assets/media/gallery-1.jpg", alt: "Player match action photo" },
      { image: "/assets/media/gallery-2.webp", alt: "Player training photo" },
      { image: "/assets/media/gallery-3.webp", alt: "Professional football player portrait" }
    ]
  },
  contact: {
